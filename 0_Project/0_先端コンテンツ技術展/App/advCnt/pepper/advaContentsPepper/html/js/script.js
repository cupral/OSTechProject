...
// =============================================================================
// アプリケーションID
var applicationID = "advacontents_pepper";
// ロボットの名前
var robotName = "pepper";
...
function indexOnload() {
  ...
  function endIndex() {
    // ランダム発言用配列
    var indexSay = new Array("\\vct=135\\\\rspd=110\\こんにちは、今日はアジュールのコンピュータ、ビジョンエーピーアイを使ったデモを行っています！","\\vct=135\\\\rspd=110\\俳句を自動生成するデモを行っています！","\\vct=135\\\\rspd=110\\よってらっしゃい見てらっしゃい","\\vct=135\\\\rspd=110\\どうもどうも");
    ...
    // 効果音を流す
    window.setTimeout(function(){
      player("playFileInLoop", "opening.mp3", 0.2);
    },1000);
  }
