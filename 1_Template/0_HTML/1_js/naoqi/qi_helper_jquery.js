...
(function ($) {
    ...
    $.sayALTextToSpeech = function(event,value){
      return $.getService("ALTextToSpeech",function(ALTextToSpeech){
        ALTextToSpeech.say(event, value).fail($.onQimError);
      });
    }

    $.sayALAnimatedSpeech = function(value) {
        return $.getService("ALAnimatedSpeech", function(ALAnimatedSpeech) {
            ALAnimatedSpeech.say(value).fail($.onQimError);
        });
    }
